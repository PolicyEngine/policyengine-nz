...
class TestTreasuryValidation:
    ...
    def test_working_for_families_scenarios(self):
        ...
        assert (
            iwtc > 4_000
        ), "In-Work Tax Credit should apply for working single parent"
    ...
    def test_effective_marginal_tax_rates(self):
        ...
        situation_new = {
            "people": {
                "person": {
                    "employment_income": {
                        "2024": base_income + additional_income
                    }
                }
            },
            "tax_units": {"unit": {"members": ["person"]}},
    ...
    def test_accommodation_supplement_regions(self):
        ...
        for region, max_rate in regions:
            ...
            assert (
                self.system.parameters.gov.msd.accommodation_supplement.max_rates
            )
