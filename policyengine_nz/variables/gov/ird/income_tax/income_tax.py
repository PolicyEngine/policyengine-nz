...
class income_tax(Variable):
    ...
    def formula(person, period, parameters):
        ...
        if taxable_income > bracket_2_start:
            bracket_2_income = min_(taxable_income - bracket_2_start, 
        ...
        if taxable_income > bracket_3_start:
            bracket_3_income = min_(taxable_income - bracket_3_start,
        ...
        if taxable_income > bracket_4_start:
            bracket_4_income = min_(taxable_income - bracket_4_start,
